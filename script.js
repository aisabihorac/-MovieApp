//Sinhroni asinhroni kod
console.log("Pocetak");
setTimeout(prvaFunkcija, 7000)
...
for (let i = 0; i < 3; i++) {
  document.getElementById(jsonMovies[i].id).src = jsonMovies[i].poster_path;
}
...
function findMovie() {
  ...
  let foundMovie = jsonMovies.find(
    (movie) => movie.title.toLowerCase() === input
  );
